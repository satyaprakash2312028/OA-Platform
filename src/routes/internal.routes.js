...
const { cacheLastAcceptedSubmission, removeCachedProblemSolvedCount } = require("../middleware/dashboard.cache.middleware.js");
const { removeCachedSubmissionPages } = require("../middleware/problem.cache.middleware.js");
const router = express.Router();

// Use the middleware to protect these internal routes
router.post("/verdict", internalRouteChecks, removeCachedSubmissionPages, getJudgeVedict);
